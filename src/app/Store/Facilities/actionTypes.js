...
export const COUNTRY_FACILITYTYPES_SUMMARY_REQUESTED = 'facility.COUNTRY_FACILITYTYPES_SUMMARY_REQUESTED'
export const COUNTRY_FACILITYTYPES_SUMMARY_RECEIVED = 'facility.COUNTRY_FACILITYTYPES_SUMMARY_RECEIVED'

export const COUNTRY_KEPHLEVELS_SUMMARY_REQUESTED = 'facility.COUNTRY_KEPHLEVELS_SUMMARY_REQUESTED'
export const COUNTRY_KEPHLEVELS_SUMMARY_RECEIVED = 'facility.COUNTRY_KEPHLEVELS_SUMMARY_RECEIVED'

export const COUNTRY_BEDS_SUMMARY_REQUESTED = 'facility.COUNTRY_BEDS_SUMMARY_REQUESTED'
export const COUNTRY_BEDS_SUMMARY_RECEIVED = 'facility.COUNTRY_BEDS_SUMMARY_RECEIVED'
...
export const COUNTY_FACILITYTYPES_SUMMARY_REQUESTED = 'facility.COUNTY_FACILITYTYPES_SUMMARY_REQUESTED'
export const COUNTY_FACILITYTYPES_SUMMARY_RECEIVED = 'facility.COUNTY_FACILITYTYPES_SUMMARY_RECEIVED'

export const COUNTY_KEPHLEVELS_SUMMARY_REQUESTED = 'facility.COUNTY_KEPHLEVELS_SUMMARY_REQUESTED'
export const COUNTY_KEPHLEVELS_SUMMARY_RECEIVED = 'facility.COUNTY_KEPHLEVELS_SUMMARY_RECEIVED'
